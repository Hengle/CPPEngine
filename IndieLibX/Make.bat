...
:help
	...
	ECHO "Example: Make.bat Test WIN VC D3D11";
	ECHO "Example: Make.bat Test WIN VC GLCG1_1";
	ECHO "Example: Make.bat Test WIN VC GLSL1_1";
	ECHO "Example: Make.bat Test WIN VC VULKAN";

	REM ECHO "Usage: $0 buildlibrary ProjectName [< ${projects} >] -> Builds an single project.";
	ECHO ""
	ECHO "Usage: %0 AllLibs WIN VC D3D11 	  -> Generates C++ static library .sln and .prj files for VC."
	ECHO "Usage: %0 Test WIN VC D3D11         -> Generates C++ Test Applications .sln and .prj files for VC."
	ECHO "Usage: %0 SampleApps WIN VC D3D11   -> Generates C++ Sample Applications .sln and .prj files for VC."
	ECHO "Usage: %0 TerrainApps WIN VC D3D11  -> Generates C++ Terrain Applications .sln and .prj files for VC."
	ECHO "Usage: %0 IndielibApps WIN VC D3D11 -> Generates C++ Indielib Applications .sln and .prj files for VC."
	ECHO "Usage: %0 TestApps WIN VC D3D11     -> Generates C++ TestApps Applications .sln and .prj files for VC."
	ECHO ""
