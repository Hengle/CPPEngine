...
class AppPy:
	...
	def init(self, width,  height):
		...
		texture4=IndieLib.IRenderer.GetRendererInstance().addImageLibTexture("/NSGUI/GUIElements.png",False,ss)
	...
	def render4(self, texture, qx, qy, dx, dy, tx=0.0, ty=0.0, stx=1.0, sty=1.0):
		...
		IndieLib.IRenderer.GetRendererInstance().TexCoord2f(1, 0)IndieLib.IRenderer.GetRendererInstance().Vertex2f(qx,qy+dy)
		IndieLib.IRenderer.GetRendererInstance().TexCoord2f(1, 1)IndieLib.IRenderer.GetRendererInstance().Vertex2f(qx,qy)
		IndieLib.IRenderer.GetRendererInstance().TexCoord2f(0, 0)IndieLib.IRenderer.GetRendererInstance().Vertex2f(qx+dx,qy+dy)
		IndieLib.IRenderer.GetRendererInstance().TexCoord2f(0, 1)IndieLib.IRenderer.GetRendererInstance().Vertex2f(qx+dx,qy)
...
if __name__=="__main__":
	app=AppPy()
	IndieLib.IRenderer.GetRendererInstance(640, 512, "Blending")		
