...
class AppPy:
	...
	def init(self, width, height):
		...
		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceSky, "/IndieLib-TankEnemies/images/frigistan_self.sky.jpg", IndieLib.IND_OPAQUE, IndieLib.IND_32):
			 return 0

		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceGnd, "/IndieLib-TankEnemies/images/frigistan_self.ground.jpg", IndieLib.IND_OPAQUE, IndieLib.IND_32):
			 return 0
		...
		if not IndieLib.CIndieLib.Instance().AnimationManager.AddToSurface (self.animTank, "/IndieLib-TankEnemies/images/self.tank.xml", IndieLib.IND_ALPHA, IndieLib.IND_32):
			 return 0
		#if not IndieLib.CIndieLib.Instance().AnimationManager.AddToSurface (self.animTank, "/IndieLib-TankEnemiesParallax/images/self.tank.xml", IndieLib.IND_ALPHA, IndieLib.IND_32):
		#return 0
		...
		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceBarrel, "/IndieLib-TankEnemies/images/self.barrel.png", IndieLib.IND_ALPHA, IndieLib.IND_32):
			 return 0
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_f):
		...
		if IndieLib.CIndieLib.Instance().Input.IsMouseButtonPressed(IndieLib.MBUTTON_LEFT) and self.g_FireDelayTimer == 0.0:
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_1):
		...
		elif IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_2):
		...
		elif IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_3):
		...
		elif IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_4):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_b):
			self.bToggleShowBounds = not self.bToggleShowBounds

		if IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_F1):
	...
	def run(self):
		self.init(0,0)
		while not IndieLib.CIndieLib.Instance().Input.IsKeyUp(IndieLib.KEY_ESCAPE):
			self.render()
