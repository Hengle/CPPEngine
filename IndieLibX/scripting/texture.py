...
float4 main(VsOut IN): COLOR {
	...
	def init(self, width,  height):
		...
		self.texture=IndieLib.IRenderer.GetRendererInstance().addImageLibTexture("/NSGUI/GUIElements.png",False,ss)
...
if __name__=="__main__":
	app=AppPy()
	IndieLib.IRenderer.GetRendererInstance(640, 512, "texture")		
