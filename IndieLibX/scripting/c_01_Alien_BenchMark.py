...
class AppPy:
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress (IndieLib.KEY_2):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress (IndieLib.KEY_3):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress (IndieLib.KEY_SPACE):
