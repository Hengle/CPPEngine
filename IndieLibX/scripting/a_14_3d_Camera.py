...
class AppPy:
	...
	def init(self, width, height):
		...
		#	return 0
		if not IndieLib.CIndieLib.Instance().MeshManager.Add (self.mMeshDino, "/trex dx/dino videogame.x", "/trex dx"):
			return 0
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_UP):
			self.mCamera3d.MoveWalk (0.01)
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_DOWN):
			self.mCamera3d.MoveWalk (-0.01)
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_z):
			self.mCamera3d.MoveStrafe (-0.01)
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_x):
			self.mCamera3d.MoveStrafe (0.01)
