...
class AppPy:
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_1):
		
			IndieLib.CIndieLib.Instance().LightManager.Disable(self.mLight2)
			IndieLib.CIndieLib.Instance().LightManager.Disable(self.mLight3)
			IndieLib.CIndieLib.Instance().LightManager.Enable(self.mLight1)
		
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_2):
		...
		if IndieLib.CIndieLib.Instance().Input.IsKeyPressed (IndieLib.KEY_3):
