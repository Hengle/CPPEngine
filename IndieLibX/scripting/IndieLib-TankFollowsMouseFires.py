...
class AppPy:
	...
	def init(self, width, height):
		...
		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceSky, "/IndieLib-TankFollowsMouseFires/images/frigistan_self.sky.png", IndieLib.IND_OPAQUE, IndieLib.IND_32):
			return 0

		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceGnd, "/IndieLib-TankFollowsMouseFires/images/frigistan_self.ground.png", IndieLib.IND_OPAQUE, IndieLib.IND_32):
			return 0

		if not IndieLib.CIndieLib.Instance().AnimationManager.AddToSurface (self.animTank, "/IndieLib-TankFollowsMouseFires/images/self.tank.xml", IndieLib.IND_ALPHA, IndieLib.IND_32):
			return 0

		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceBarrel, "/IndieLib-TankFollowsMouseFires/images/self.barrel.png", IndieLib.IND_ALPHA, IndieLib.IND_32):
			return 0
		...
		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceBullet, "/IndieLib-TankFollowsMouseFires/images/self.bullet.png", IndieLib.IND_ALPHA, IndieLib.IND_32):
			return 0
	...
	def render(self):
		...
		if 5 and IndieLib.CIndieLib.Instance().Input.OnMouseButtonPress(IndieLib.MBUTTON_LEFT):		
