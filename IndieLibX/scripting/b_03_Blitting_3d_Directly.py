...
class AppPy:
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress (IndieLib.KEY_UP):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress (IndieLib.KEY_DOWN):
		...
		IndieLib.CIndieLib.Instance().Render.SetRainbow3d(1, 0, IndieLib.IND_FILTER_LINEAR, 255, 255, 255, 255, 0, 0, 0, 255, IndieLib.IND_SRCALPHA, IndieLib.IND_INVSRCALPHA)
