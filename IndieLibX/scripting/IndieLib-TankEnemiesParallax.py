...
class AppPy:
	...
	def init(self, width, height):
		...
		if not IndieLib.CIndieLib.Instance().SurfaceManager.Add(self.surfaceBarrel, "/IndieLib-TankEnemiesParallax/images/self.barrel.png", IndieLib.IND_ALPHA, IndieLib.IND_32):
			return 0
	...
	def render(self):
		...
		if IndieLib.CIndieLib.Instance().Input.OnKeyPress(IndieLib.KEY_F2):
