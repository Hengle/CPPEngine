...
#if 1//(!defined(libnova_M_PI) && (!defined(_MSC_VER) || !defined(_USE_MATH_DEFINES)))
#define libnova_M_PI2          1.5707963267948966192313216916398
#define libnova_M_PI4          0.78539816339744830961566084581988
#define libnova_M_PI            3.1415926535897932384626433832795
#endif
...
struct ln_zonedate
{
    ...
    int minutes; 	/*!< Minutes. Valid values 0 - 59. */
    double seconds;	/*!< Seconds. Valid values 0 - 59.99999.... */
    int gmtoff;        /*!< Timezone offset. Seconds east of UTC. Valid values 0..86400 */
};
