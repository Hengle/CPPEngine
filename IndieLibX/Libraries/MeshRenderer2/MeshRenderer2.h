...
// http://www.songho.ca/opengl/gl_sphere.html
	...
	void CreateHemis_(int stepLng=20, int stepLat=20, tShader aShader_=eShaderNone);
	void CreateTorus(float radMajor=1.0f, float radMinor=1.0f, tShader aShader=eShaderNone);
	void CreateTorus_(float radMajor=1.0f, float radMinor=1.0f, int num_rings=20, int num_segments=20, int slices=20, int stacks=20, tShader aShader=eShaderNone);
#endif
	...
	void CreateEllipsoid_(float fA=1.0f, float fB=1.0f, float fC=1.0f, int slices=20, int stacks=20, tShader aShader=eShaderNone);
        ...
        void CreateCylinder_(float bottomRadius=1.0f, float topRadius=1.0f, float length=2.0f, int aslices=20, int stacks=20, tShader aShader=eShaderNone);
...
public:
	...
	unsigned int GetNumVertices( unsigned int m, unsigned int a ){return 0;}
