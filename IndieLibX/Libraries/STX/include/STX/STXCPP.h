...
#if !defined(_WIN32)&&!defined(SDL_2_0_4_BUILD)&& !defined(WIN_PHONE_APP) && !defined(ANDROID) && !defined(__APPLE__)
#include <X11/X.h>
#include <X11/Xlib.h>
#include <X11/Xutil.h>
...
#  endif
#elif !defined(_WIN32)&&!defined(SDL_2_0_4_BUILD)&& !defined(WIN_PHONE_APP) && !defined(ANDROID) && !defined(__APPLE__)
...
#ifndef _MSC_VER
#ifdef __cplusplus
inline DWORD STXAPI timeGetTime()
{
