...
static size_t
stx_ScanLong(const char *text, int radix, long *valuep)
{
...
static size_t
stx_ScanUnsignedLong(const char *text, int radix, unsigned long *valuep)
{
    const char *textstart = text;
...
#else
    return stx_ltoa((long)value, string, radix);
#endif /* HAVE_ITOA */
}
...
#else
    return stx_ultoa((unsigned long)value, string, radix);
#endif /* HAVE__UITOA */
}

char *
stx_ltoa(long value, char *string, int radix)
{
...
char *
stx_ultoa(unsigned long value, char *string, int radix)
{
...
static size_t
stx_PrintLong(char *text, size_t maxlen, stx_FormatInfo *info, long value)
{
    char num[130];
...
static size_t
stx_PrintUnsignedLong(char *text, size_t maxlen, stx_FormatInfo *info, unsigned long value)
{
    char num[130];
