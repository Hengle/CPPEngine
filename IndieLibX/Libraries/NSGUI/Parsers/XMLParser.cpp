...

{
  ...
  return index >= children.size() ? 0 : children[index];
...
NSString &XMLElement::getValue() { return value;              }
...
void XMLElement::loadRX_GY_BZ_AWf(XMLElement &element, D3DXFROMWINEVECTOR4 &attributes)
...
void XMLElement::loadRX_GY_BZf(XMLElement &element, D3DXFROMWINEVECTOR3 &attributes)
...
void XMLElement::loadRX_GYf(XMLElement &element,  D3DXFROMWINEVECTOR2 &attributes)
...

{
  ...
  return clampNS(bufferSize - bufferProgress, 0, bufferSize);
...
void XMLStack::getIdentifier(char **stream, NSString& identifier)
...
void XMLStack::getStreamedValue(char **stream, NSString& streamedVals)
...

{
...

  {
    ...
    memset(subStream,      0, bytesCount + 1);
...

  {
    ...
    memset(subStream,      0, charCounter + 1);
...
void XMLStack::getStringValue(char **stream, NSString &value)
