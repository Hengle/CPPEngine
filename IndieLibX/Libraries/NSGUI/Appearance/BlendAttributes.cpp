...

{
  ...
  if(!xmlFile.is_open())
    ...
    {Logger::writeErrorLog(NSString("Cannot export BlendAttributes to XML: file not ready."));return false;}



  if(destination == -1.0f || source == -1.0f)

    {Logger::writeErrorLog(NSString("Cannot export BlendAttributes to XML: invalid attributes {-1.0}."));return false;}
...
*/
  ...
  Logger::writeErrorLog(NSString("Invalid Blend Source, BlendAttributes::setSource(int source)"));
...
*/
  ...
  Logger::writeErrorLog(NSString("Invalid Blend Destination, BlendAttributes::setDestination(int destination)"));
