...
TiXmlElement* e = (TiXmlElement*)FirstChildElement(value);
...
TiXmlElement* TiXmlNode::ChildElementN(const unsigned int i) const
{
int count = 0;

TiXmlElement* e = (TiXmlElement*)FirstChildElement();
if(i==0) return e;
...
TiXmlElement* TiXmlNode::getChildByName(const char *a) const
{
	TiXmlElement* e = (TiXmlElement*)FirstChildElement();
	return 0;//??? e->FirstChild(a)->Element();
}
