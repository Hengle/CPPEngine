                               ...
                               float fHeightScale, bool bCreateTiles )
{
    ...
    LoadBMPImage( strHeightMap ) ;
        ...
        for (int y = 0; y < 512; y++){
                memcpy(m_pHeightBits + 1024  * y,           m_pHeightBitsTmp + 512 * y, 512);
                memcpy(m_pHeightBits + 1024  * y + 512,           m_pHeightBitsTmp + 512 * y, 512);
                memcpy(m_pHeightBits + 1024  * (y + 512),           m_pHeightBitsTmp + 512 * y, 512);
                memcpy(m_pHeightBits + 1024  * (y + 512) + 512,           m_pHeightBitsTmp + 512 * y, 512);
        }
