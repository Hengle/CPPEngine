...
#pragma comment(lib, "C:\\IndieLibX\\lib\\MeshRenderer.lib")
#endif
#pragma comment(lib, "C:\\IndieLibX\\lib\\tinyxml.lib")
#pragma comment(lib, "C:\\IndieLibX\\lib\\IndieLib_Static.lib")
#endif
#define IndieLib() WINAPI WinMainX (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
#elif !defined(_MSC_VER)
...
extern VertexFormatID INDIELIBAPI D3DFVF_PIXEL;
//(D3DFVF_XYZ | D3DFVF_DIFFUSE)
extern ShaderID INDIELIBAPI D3DSHA_PIXEL;
...
extern VertexFormatID INDIELIBAPI D3DFVF_CUSTOMVERTEX2D;
extern VertexFormatID INDIELIBAPI D3DFVF_CUSTOMVERTEX2DW;
//(D3DFVF_XYZ | D3DFVF_TEX1)
void InitPixel(ShaderID& s, VertexFormatID& vf);

extern ShaderID INDIELIBAPI D3DSHA_CUSTOMVERTEX2D;
void InitCUSTOMVERTEX2D(ShaderID& s, VertexFormatID& vf);
extern ShaderID INDIELIBAPI D3DSHA_CUSTOMVERTEX2DW;
...
class IGameLogic : public STXGUI
{
	public:
		...
		virtual int init(unsigned int width, unsigned int height)=0;
