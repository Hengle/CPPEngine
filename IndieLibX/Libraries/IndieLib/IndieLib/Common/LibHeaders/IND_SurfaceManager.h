...
private:
	...
	FORMAT			GetSourceFormat	(IND_Image *pImage);
	FORMAT			GetDestFormat	(IND_Surface *pNewSurface, IND_Type pType, IND_Quality pQuality);
	...
	TextureID	CreateTexture	(byte *pImage,
										int pBlockWidth,
										int pBlockHeight,
										int pSrcBpp,
										FORMAT pSrcFormat,
