...
void IND_3dMesh::SetAnimIndex( size_t pAnimIndex){m3dMesh->GetAsset()->mAnimator->SetAnimIndex(pAnimIndex);}
	...
	unsigned int		IND_3dMesh::GetCurrentSequence		()	{ return m3dMesh->GetAsset()->mAnimator->CurrentAnimIndex();			}
	//! Return the number of sequence animations of the 3d Mesh
	int					IND_3dMesh::GetNumSequences			()	{ return m3dMesh->GetAsset()->mAnimator->mScene->mNumAnimations;		}
#else
void IND_3dMesh::SetAnimIndex( size_t pAnimIndex){m3dMesh->mAnimator->SetAnimIndex(pAnimIndex);}

	//! Return the name of the loaded 3d Mesh
	//char				*IND_3dMesh::GetMeshName			()	{ return m3dMesh.mAttributes.mName				}
	//! Return the number of the sequence that is being rendered at this moment
	unsigned int		IND_3dMesh::GetCurrentSequence		()	{ return m3dMesh->mAnimator->CurrentAnimIndex();			}
	//! Return the number of sequence animations of the 3d Mesh
