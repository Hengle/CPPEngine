...
pNew3dMesh->m3dMesh=new AssimpView::MeshRenderer();//pPath.c_str());
...
pNew3dMesh->m3dMesh->LoadAsset(pName.c_str());
	...
	if(pNew3dMesh->m3dMesh->GetAsset()->mAnimator)
...
bool IND_3dMeshManager::Delete (IND_3dMesh *pMe)
{
	...
	Debug->DataChar (pMe->m3dMesh->GetFileName(),1);//GetMeshName (), 1)
...
void IND_3dMeshManager::FreeVars ()
{
	...
	{
		Debug->Header	("Freeing 3d mesh:", 3);
		Debug->DataChar ((*mListIter)->m3dMesh->GetFileName(),1);//GetMeshName (), 1)
