...
bool IND_Entity2dManager::Add (IND_Entity2d *pNewEntity2d)
{
	...
	Debug->Header ("Name:", 3);
	Debug->DataInt (long(pNewEntity2d), 1);
...
*/
INLINE 
void	IND_Entity2dManager::RenderGridAreas	(byte pR, byte pG, byte pB, byte pA)
{
...
void IND_Entity2dManager::FreeVars ()
{
	...
	for (int i = 0; i < NUM_LAYERS; i++)
	{
			 ...
			 mEntityListIter++)
		{
			...
			Debug->DataInt (long( (*mEntityListIter)), 1);
		}
