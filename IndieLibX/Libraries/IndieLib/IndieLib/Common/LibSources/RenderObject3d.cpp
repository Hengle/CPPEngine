...
*/
INLINE void IND_Render::Blit3dMesh	(/*int ab,*/IND_3dMesh *p3dMesh)
{
	...
	if (p3dMesh->m3dMesh->m_pcAsset->mAnimator->mRootNode)
		DrawFrame (p3dMesh,p3dMesh->m3dMesh->m_pcAsset->pcScene);
#endif
}
...
*/
void IND_Render::Set3dMeshSequence (/*int ab,*/IND_3dMesh *p3dMesh, unsigned int pIndex)
{
	if (pIndex == p3dMesh->m3dMesh->m_pcAsset->mAnimator->CurrentAnimIndex())
		return;

	if (pIndex >= (unsigned int) p3dMesh->m3dMesh->m_pcAsset->mAnimator->mScene->mNumAnimations )
		pIndex = 0;

	// Remember current animation
//	p3dMesh->m3dMesh.m_currentAnimationSet = pIndex;
	p3dMesh->m3dMesh->m_pcAsset->mAnimator->SetAnimIndex(pIndex);
#if 0
...
*************************
*/
void IND_Render::DrawFrame(IND_3dMesh *p3dMesh,aiScene* pFrame)
{
#if 0
	...
	p3dMesh->m3dMesh->render();//(mInfo.mDevice,p3dMesh->m3dMesh->m_pcAsset->mAnimator->mRootNode)
#endif
}
...
*************************
*/
void IND_Render::DrawMeshContainer(IND_3dMesh *p3dMesh,aiScene* meshContainerBase, aiScene* frameBase)
{
#if 0
	...
	p3dMesh->m3dMesh->render();//p3dMesh->DrawScene(mInfo.mDevice,p3dMesh->m3dMesh->m_pcAsset->mAnimator->mRootNode)
#endif
