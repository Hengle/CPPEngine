...
int CALLBACK CMudgeFontDlg::EnumFontsProc(CONST LOGFONT* lplf, CONST TEXTMETRIC* lptm, DWORD dwType, LPARAM lpData)
{
...
void CMudgeFontDlg::UpdateUI(DWORD nHeight, DWORD nWeight, DWORD nQuality, DWORD nSampling, const CString& Facename)
{
	int i, len;
