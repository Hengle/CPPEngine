#if defined(GLSL4_5) || defined(GLSL1_1) || defined(GLCG1_1)
...
{
public:
#if defined(_MSC_VER) && defined(GLSL1_1)
	union
	{
		HDC hdc;
		HDC hDc;
