...
struct ShaderFXD3D9 : public Shader
{
	...
	virtual int getSamplerUnit(int shader, const char* textureName);
...
void LoadTexture(const Image3* img, LPDIRECT3DBASETEXTURE9* ret, bool atlas=false, FORMAT f=FORMAT_RGB8, unsigned int w=0, unsigned int h=0, DWORD u=0);
...
union
	...
	RendererHLSLD3D9(int awidth=800, int aheight=600,
