...
#endif
{
	...
	_IRenderer_BodyElement = 0; // ??? docHandle.FirstChild("Body").Element();
	if(_IRenderer_BodyElement) 
		Debug = _IRenderer_BodyElement->FirstChild("Debug")->ToElement()->Attribute("Value");
	}
#endif
		if(Debug=="True")
			m_bDebug=true;
