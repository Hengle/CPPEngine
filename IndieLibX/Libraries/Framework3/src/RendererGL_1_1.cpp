...
{
{
	...
	printf("GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS=%d\n", N);
	glGetIntegerv(GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS, &N);
	printf("GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS=%d\n", N);
	glGetIntegerv(GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS, &N);
	printf("GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS=%d\n", N);
	glGetIntegerv(GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS, &N);
	printf("GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS=%d\n", N);
#endif
}
