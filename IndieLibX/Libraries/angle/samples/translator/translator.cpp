...
int translateX(const char* vert, const char* frag)
{
    TFailCode failCode = ESuccess;
    ...
    /*
	compileOptions |= SH_INTERMEDIATE_TREE; break;
	compileOptions |= SH_MAP_LONG_VARIABLE_NAMES; break;
        compileOptions |= SH_OBJECT_CODE; break;
        compileOptions |= SH_VARIABLES; break;
        compileOptions |= SH_UNROLL_FOR_LOOP_WITH_INTEGER_INDEX; break;
        compileOptions |= SH_EMULATE_BUILT_IN_FUNCTIONS; break;
        compileOptions |= SH_DEPENDENCY_GRAPH; break;
        compileOptions |= SH_TIMING_RESTRICTIONS; break;
    */
	spec = SH_GLES2_SPEC;
	output = SH_GLSL_OUTPUT; break;
...
void usage()
{
    printf("Usage: translate [-i -m -o -u -l -e -b=e -b=g -b=h -x=i -x=d] file1 file2 ...\n"
        //translate -b=g filename ending in .frag or .vert
