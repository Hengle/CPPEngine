...
public:
  ...
  void draw(Renderer* renderer)
  {
    ...
    if(material->shader->id>=IRenderer::GetRendererInstance()->GetShaderCount())
	return;
    ...
    renderer->setupArray(vertexlist->getVertices(), vertexlist->getCount(), (tangentlist)?tangentlist->getTangents():0, (tangentlist)?tangentlist->getCount():0);
