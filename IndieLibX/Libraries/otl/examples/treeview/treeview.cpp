...
int ApplicationLogic()
{
  int argc0=0;
  char ** argv0=0;
  IRenderer* r=IRenderer::GetRendererInstance(640, 512, "Treeview");
  IInput*    i=STX_Service::GetInputInstance();
  {
  int argc=4;
  char * argv[]={"apptreeview", "otl-xml", "otl-weber", "/otldata/weber-xml/weeping_willow.xml"};
  //char * argv[]={"apptreeview", "arbaro-xml", "arbaro-weber", "/otldata/arbaro-xml/weeping_willow.xml"};
  if (argc != 4)
  {
  ...
  std::string file=stx_convertpath(argv[3]);
  ...
  return SDL_FrameWork(new TreeView(argv[1], argv[2], file.c_str())).run();
  }
}
...
void TreeView::init()
{
  bump_shader.init("/otldata/shaders/parallax.shd", "parallax");
  //shader.init("/otldata/shaders/nmap.shd", "nmap");
  normal_shader.init("/otldata/shaders/normals.shd", "normals");
  leaf_shader.init("/otldata/shaders/leaves.shd", "leaves");
  ...
  stem_tex = renderer->loadTexture("/otldata/textures/vertical_bark.jpg");
  stem_tex_n = renderer->loadTexture("/otldata/textures/vertical_bark_n.jpg");
  stem_tex_h = renderer->loadTexture("/otldata/textures/vertical_bark_h.jpg");

  branch_tex = renderer->loadTexture("/otldata/textures/bark.jpg");
  branch_tex_n = renderer->loadTexture("/otldata/textures/bark_n.jpg");
  branch_tex_h = renderer->loadTexture("/otldata/textures/bark_h.jpg");

#ifndef BBC
  leaves_tex = renderer->loadTexture("/otldata/textures/leaf_tria.png");
#else
  // TO BE DONE: This shouldn't be loaded from a texture but rendered to one.
  leaves_tex = renderer->loadTexture("/otldata/textures/leaves.png");
#endif

  /*
  stem_tex = renderer->loadTexture("/otldata/textures/box.jpg");
  branch_tex = renderer->loadTexture("/otldata/textures/box.jpg");
  normal_tex = renderer->loadTexture("/otldata/textures/boxn.jpg");
  height_tex = renderer->loadTexture("/otldata/textures/boxh.jpg");
  */
  ...
  renderer->setupArray(vertices.getVertices(), vertices.getCount(), trunk_tangents.getTangents(), trunk_tangents.getCount());
}
