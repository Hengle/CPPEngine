<html>
 ...
 <table>
    ...
    <TR><TD>Name:</TD><TD>Size in bytes:</TD><TD>Last Updated:</TD><TD>Comments:</TD></TR>
...
if (file_exists($filename)) {
    echo "<TR><TD><A TARGET='_blank' HREF='http://tommironty.fi/".$filename."'>".$filename."</A></TD><TD>".filesize($filename)."</TD><TD>".date("F d Y H:i:s.", filemtime($filename))."</TD><TD><P>3D models loaded with assimp-3.2 static library.</P></TD><TD><P></P></TD></TR>";
}

$filename = './IndieLibX3.zip';
if (file_exists($filename)) {
    echo "<TR><TD><A TARGET='_blank' HREF='http://tommironty.fi/".$filename."'>".$filename."</A></TD><TD>".filesize($filename)."</TD><TD>".date("F d Y H:i:s.", filemtime($filename))."</TD><TD><P>3D models loaded with new MeshRenderer3 static library. Less 3D models rendered succesfully.</P></TD><TD><P></P></TD></TR>";
}
...
if (file_exists($filename)) {
    echo "<TR><TD><A TARGET='_blank' HREF='http://tommironty.fi/".$filename."'>".$filename."</A></TD><TD>".filesize($filename)."</TD><TD>".date("F d Y H:i:s.", filemtime($filename))."</TD><TD>Compiles. Rendering (GLSL1_1: OpenGL 3.1 / GLSL 1.40) succeeds.</TD><TD></TD></TR>";
}
...
if (file_exists($filename)) {
    echo "<TR><TD><A TARGET='_blank' HREF='http://tommironty.fi/".$filename."'>".$filename."</A></TD><TD>".filesize($filename)."</TD><TD>".date("F d Y H:i:s.", filemtime($filename))."</TD><TD>Compiles. Rendering (D3D11: DirectX11) succeeds.</TD><TD></TD></TR>";
}
