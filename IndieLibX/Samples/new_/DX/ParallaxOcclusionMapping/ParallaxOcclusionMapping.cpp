...
//--------------------------------------------------------------------------------------
char*                      g_strMeshFileName0 = "Disc.x";
...
int LoadEffectFile()
{
    g_pEffect = IRenderer::GetRendererInstance()->addEffectFromFile("ParallaxOcclusionMapping.fx");
    return 0;
}
...
int  OnCreateDevice(   )
{
    ...
    // Load the mesh 
    g_pMesh.Load(g_strMeshFileName0, eSimpleShader, true, true);
