...
bool load(){
	...
	// Load shaders
	skybox   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/skybox.shd"  );
	lighting = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/lighting.shd");
	blur     = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/blur.shd"    );
	convert  = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/convert.shd" );
	average  = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/average.shd" );
	exposure = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/exposure.shd");
	hdrCPU   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/HDRCPU.shd"     );
	hdrGPU   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/HDR/HDR/HDRGPU.shd"     );
	...
	if ((base[1] = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/parqfloor2.dds", FILTER_TRILINEAR_ANISO)) == TEXTURE_NONE) return false;
