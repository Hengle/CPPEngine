...
int OnCreateDevice()
{
    ...
    g_pEffect=IRenderer::GetRendererInstance()->addEffectFromFile("/RaycastTerrain/RaycastTerrain.fx");
    ...
    g_pDetailHeightTexture=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMapHeight.dds", false);

    // Load the detail diffuse textures
    g_pDetailColorTexture[0]=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMap_Red.dds", false);
    g_pDetailColorTexture[1]=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMap_Green.dds", false);
    g_pDetailColorTexture[2]=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMap_Blue.dds", false);
    g_pDetailColorTexture[3]=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMap_Alpha.dds", false);

    g_pDetailGrad_RedGreen=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMapGrad_RedGreen.dds", false);
    g_pDetailGrad_BlueAlpha=IRenderer::GetRendererInstance()->addImageLibTexture("/RaycastTerrain/DetailMapGrad_BlueAlpha.dds", false);
    ...
    //g_BoxMesh.Create( "/RaycastTerrain/bobble.sdkmesh" );
    g_BoxMesh.CreateTexturedBox(1.0f, 1.0f, 1.0f, eSimpleShader);

    // Load the mesh version of the terrain
    ( g_Terrain.LoadTerrain( "/RaycastTerrain/MSH1024.bmp", 1, 1200, g_fMapWidth, g_fMapHeight, 10, 1.0f, 2.0f ) );
...
int PreprocessTerrain( char* strHeightMap, char* strMapOut )
{
    ...
    TextureID pTerrainTexture = 0;
    ( ->CreateTexture2D( &Desc, &InitData, &pTerrainTexture ) );
