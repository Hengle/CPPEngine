...
int  OnCreateDevice()
{
    ...
    g_pEffect=IRenderer::GetRendererInstance()->addEffectFromFile("/Island11/Island11.fx");
...
void  OnFrameRender( double fTime, float fElapsedTime )
{
	...
	g_pEffect->GetVariableByName("g_ZNear")->SetFloat(scene_z_near);
	g_pEffect->GetVariableByName("g_ZFar")->SetFloat(scene_z_far);
	g_pEffect->GetVariableByName("g_LightPosition")->SetFloatVector(g_LightPosition);
	g_pEffect->GetVariableByName("g_WaterBumpTexcoordShift")->SetFloatVector(WaterTexcoordShift);
	g_pEffect->GetVariableByName("g_ScreenSizeInv")->SetFloatVector(ScreenSizeInv);

	g_pEffect->GetVariableByName("g_DynamicTessFactor")->SetFloat(g_DynamicTessellationFactor);
	g_pEffect->GetVariableByName("g_StaticTessFactor")->SetFloat(g_StaticTessellationFactor);
	g_pEffect->GetVariableByName("g_UseDynamicLOD")->SetFloat(g_UseDynamicLOD?1.0f:0.0f);
	g_pEffect->GetVariableByName("g_RenderCaustics")->SetFloat(g_RenderCaustics?1.0f:0.0f);
	g_pEffect->GetVariableByName("g_FrustumCullInHS")->SetFloat(g_FrustumCullInHS?1.0f:0.0f);
