...
bool createLinksVBO()
{
	...
	if ((VF = IRenderer::GetRendererInstance()->addVertexFormat(modelVertexAttribs, elementsOf(modelVertexAttribs))) == VF_NONE) return false;
...
{
	// Load shaders
	quadShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/quad.shd", "main", "main");
	computeTransformMatrixShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/computeTransformMatrix.shd", "main", "main");
	computeCCDShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/computeCCD.shd", "main", "main");
	transformLinkShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/transformLink.shd", "main", "main");
	drawLinkShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/drawLink.shd", "main", "main");
	generatePivotMatrixShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/generatePivotMatrix.shd", "main", "main");
	...
	QuadVF = IRenderer::GetRendererInstance()->addVertexFormat(quadAttribs, elementsOf(quadAttribs), -1);
	...
	target.load(stx_convertpath("/R2VB/IK_Target/IK_Target.AM").c_str());
	...
	DiffuseMap = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/ChessBoard.dds", false, IRenderer::GetRendererInstance()->GettrilinearAniso());
...
{
	Shader = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-IK/target.shd", "main", "main");
	...
	if ((VertexFormat = IRenderer::GetRendererInstance()->addVertexFormat(modelVertexAttribs, elementsOf(modelVertexAttribs))) == VF_NONE) return false;
