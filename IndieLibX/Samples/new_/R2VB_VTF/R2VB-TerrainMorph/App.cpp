...
bool load()
{
	...
	// Load shaders
	skybox = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-TerrainMorph/skybox.shd", "main", "main");
	terrain = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-TerrainMorph/terrain.shd", "main", "main");
	terrainGen = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-TerrainMorph/terrainGen.shd", "main", "main");
	/*
	...
	*/
	...
	// Load height maps
	heightMap[0]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024.tga", false, IRenderer::GetRendererInstance()->Getlinear());
	heightMap[1]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024_1.tga", false, IRenderer::GetRendererInstance()->Getlinear());
	heightMap[2]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024_4.tga", false, IRenderer::GetRendererInstance()->Getlinear());
	heightMap[3]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024_5.tga", false, IRenderer::GetRendererInstance()->Getlinear());

	// Load diffuse maps
	terrainMap[0]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/terrain.dds", false, IRenderer::GetRendererInstance()->GetlinearAniso());
	terrainMap[1]=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/terrain_3.dds", false, IRenderer::GetRendererInstance()->GetlinearAniso());
