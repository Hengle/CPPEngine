...
bool load(){
	// Load shaders
	wave   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Water/wave.shd", "main", "main");
	drop   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Water/drop.shd", "main", "main");
	skybox = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Water/skybox.shd", "main", "main");
	water  = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Water/water.shd", "main", "main");
	pool   = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Water/pool.shd", "main", "main");
	...
	*/
	...
	brick=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/parqfloor2.dds", false, IRenderer::GetRendererInstance()->GettrilinearAniso());
	...
	std::vector<float> vv(RT_SIZE * RT_SIZE*2);
	float *dest = &vv[0];
