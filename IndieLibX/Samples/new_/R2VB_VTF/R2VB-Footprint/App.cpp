...
{
	R2VBAnimation::load(modelname, diffuse, maxtexsize, debugruntime, "/new/x/x/R2VB_VTF/R2VB-Footprint");
	footprintShader = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/footprint.shd", "main", "main");
	
	bool supportsHalf = IRenderer::GetRendererInstance()->supportsHalf();
	const FormatDesc fdesc[] = {
		0, TYPE_VERTEX,   supportsHalf? FORMAT_HALF : FORMAT_FLOAT, 3,
	};
...
{
	// load shaders
	terrain.generateHeightShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/generateHeight.shd", "main", "main");
	terrain.accumulateHeightShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/accumulateHeight.shd", "main", "main");
	terrain.deformShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/deformShd.shd", "main", "main");
	terrain.blurShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/blur.shd", "main", "main");

	char			Buffer[256];

	stx_snprintf(Buffer, 256, "%s%s", TEX_PATH, "/R2VB/height1024_5.tga");
	terrain.heightMap = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024_5.tga", false, IRenderer::GetRendererInstance()->GettrilinearAniso());

	stx_snprintf(Buffer, 256, "%s%s", TEX_PATH, "/R2VB/height1024_7.tga");
	terrain.heightMapAccumulated = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/height1024_7.tga", false, IRenderer::GetRendererInstance()->GettrilinearAniso());

	stx_snprintf(Buffer, 256, "%s%s", TEX_PATH, "/R2VB/noiseFillMap.png");
	terrain.noiseFillMap = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/noiseFillMap.png", false, IRenderer::GetRendererInstance()->GettrilinearAniso());
	...
	if ((terrain.VF = IRenderer::GetRendererInstance()->addVertexFormat(vertexAttribs, elementsOf(vertexAttribs), terrainSH)) == VF_NONE) return false;
...
{
	// Load shaders
	skybox = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/skybox.shd", "main", "main");
	terrainSH  = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/terrain.shd", "main", "main");
	dumpShd = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Footprint/DumpTexture.shd", "main", "main");
	...
	if (!createTerrain("/R2VB/height1024_5.tga")) return false;

	if (!player.load("boy03/boy03", "boy03.dds", IRenderer::GetRendererInstance()->GetMaxTextureWidth(), debugRuntime)) return false;//, "/new/x/x/R2VB_VTF/R2VB-Footprint")) return false;
