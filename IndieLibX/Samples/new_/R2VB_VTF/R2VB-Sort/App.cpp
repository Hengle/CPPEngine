...
int init(const char* aTitle)
{
	...
	terrain     = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/terrain.shd", "main", "main");
	smoke       = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/smoke.shd", "main", "main");
	distance    = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/distance.shd", "main", "main");
	bitonicSort = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/bitonicSort.shd", "main", "main");
	makeQuads   = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/makeQuads.shd", "main", "main");		
	initSmoke   = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/initSmoke.shd", "main", "main");
	particles   = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/particles.shd", "main", "main");
	skybox      = IRenderer::GetRendererInstance()->addShaderFromFile("/R2VB-Sort/skybox.shd", "main", "main");
	...
	// Ground texture
	terrainTex = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/Ground_12-1.dds", false, IRenderer::GetRendererInstance()->GettrilinearAniso());
	...
	std::string fn="/R2VB-Sort/grass001.png";
	grass0.loadImageLibImage(fn.c_str());
	fn="/R2VB-Sort/grass002.png";
	grass1.loadImageLibImage(fn.c_str());
	fn="/R2VB-Sort/MapleLeaves.png";	
...
#define SCALE 0.1482f
	Image3 img;
	//fn=stx_convertpath("/R2VB-Sort/FireNoise.dds");
	//img.loadImageLibImage(fn.c_str());
	{
		...
		img.saveDDS("/R2VB-Sort/FireNoise.dds");
	}
	...
	smokeTex=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/SmokeAnimation.dds", false, IRenderer::GetRendererInstance()->GettrilinearClamp());
	...
	firePalette = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/FirePalette.png", false, IRenderer::GetRendererInstance()->GetlinearClamp());
...
/*
1>STX.lib(Noise.obj) : error LNK2005: "void __cdecl initPerlin(void)" (?initPerlin@@YAXXZ) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl noise1(float)" (?noise1@@YAMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl noise2(float,float)" (?noise2@@YAMMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl noise3(float,float,float)" (?noise3@@YAMMMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl tileableNoise1(float,float)" (?tileableNoise1@@YAMMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl tileableNoise3(float,float,float,float,float,float)" (?tileableNoise3@@YAMMMMMMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl tileableTurbulence3(float,float,float,float,float,float,float)" (?tileableTurbulence3@@YAMMMMMMMM@Z) already defined in App.obj
1>STX.lib(Noise.obj) : error LNK2005: "float __cdecl turbulence2(float,float,float)" (?turbulence2@@YAMMMM@Z) already defined in App.obj
1>   Creating library ..\..\..\bin\R2VB-Sort.lib and object ..\..\..\bin\R2VB-Sort.exp
1>..\..\..\bin\R2VB-Sort.exe : fatal error LNK1169: one or more multiply defined symbols found
1>Done building project "R2VB-Sort.vcxproj" -- FAILED.
*/
