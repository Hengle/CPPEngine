...
bool load(){
	...
	// Load shaders
	skybox         = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/skybox.shd", "main", "main");
	floorShader    = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/floor.shd", "main", "main");
	particleShader = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/particle.shd", "main", "main");
	physics        = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/physics.shd", "main", "main");
	initPhysics    = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/initPhysics.shd", "main", "main");
	makeQuads      = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-ParticleSystem/makeQuads.shd", "main", "main");
	...
	*/
	...
	particle=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/particle.dds", false, IRenderer::GetRendererInstance()->Getbilinear());
	palette=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/sparkPalette.dds", false, IRenderer::GetRendererInstance()->Gettrilinear());
