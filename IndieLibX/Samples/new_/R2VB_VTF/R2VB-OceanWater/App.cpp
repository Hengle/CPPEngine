...
bool load()
{
   ...
   if(menu){
    ...
    // Load shaders
    m_waterRenderShader = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-OceanWater/WaterRender.shd", "main", "main");
    m_skyboxShader = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-OceanWater/skybox.shd", "main", "main");

    // Load Textures
    m_skyboxTexture=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB/MarlinCube.dds", false, IRenderer::GetRendererInstance()->Gettrilinear());
    sb.init("/R2VB/MarlinCube.dds");
...
void drawFrame()
{
    ...
    if (menu && menu->isItemChecked(m_wireFrameMenuID))
    {
...
/*
1>------ Build started: Project: R2VB-OceanWater, Configuration: Debug Win32 ------
1>cl : Command line warning D9035 : option 'Gm' has been deprecated and will be removed in a future release
1>GPUPhysics.cpp
1>C:\IndieLibX\Samples\new_\R2VB_VTF\R2VB-OceanWater\GPUphysics.h(29,33): error C2440:  'return': cannot convert from 'TextureID' to 'float *'
1>CPUphysics.cpp
1>App.cpp
1>C:\IndieLibX\Samples\new_\R2VB_VTF\R2VB-OceanWater\GPUphysics.h(29,41): message :  Conversion from integral type to pointer type requires reinterpret_cast, C-style cast or function-style cast
1>C:\IndieLibX\Samples\new_\R2VB_VTF\R2VB-OceanWater\GPUphysics.h(29,33): error C2440:  'return': cannot convert from 'TextureID' to 'float *'
1>Generating Code...
1>C:\IndieLibX\Samples\new_\R2VB_VTF\R2VB-OceanWater\GPUphysics.h(29,41): message :  Conversion from integral type to pointer type requires reinterpret_cast, C-style cast or function-style cast
1>Done building project "R2VB-OceanWater.vcxproj" -- FAILED.
