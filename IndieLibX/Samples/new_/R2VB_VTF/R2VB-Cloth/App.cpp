...
bool load(){
	...
	initCloth[0] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define CURTAIN\n");
	initCloth[1] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define SAIL\n");
	initCloth[2] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define SAFETYNET\n");
	initCloth[3] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define ROUNDTABLE\n");
	initCloth[4] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define SQUARETABLE\n");
	initCloth[5] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/initCloth.shd", "main", "main", "#define SQUARETABLE2\n");
	...
	//if (caps.PS20Caps.NumInstructionSlots >= 512)
	{
		physics = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/physics.shd", "main", "main", "#define NODE_COUNT 20\n#define FIRST_PASS\n#define LAST_PASS\n");
	}

	physicsMP[0] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/physics.shd", "main", "main", "#define NODE_COUNT 6\n#define FIRST_PASS\n");
	physicsMP[1] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/physics.shd", "main", "main", "#define NODE_COUNT 5\n");
	physicsMP[2] = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/physics.shd", "main", "main", "#define NODE_COUNT 4\n#define LAST_PASS\n");

    // The rest of the needed shaders
	lighting = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/lighting.shd", "main", "main");
	tangentSpace = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/tangentSpace.shd", "main", "main");
	interleave = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/interleave.shd", "main", "main");
	hit = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/hit.shd", "main", "main");
	setNode = IRenderer::GetRendererInstance()->addShaderFromFile("/new/x/x/R2VB_VTF/R2VB-Cloth/setNode.shd", "main", "main");

	// The cloth texture
	base=IRenderer::GetRendererInstance()->addImageLibTexture("wallpaper.dds", false, IRenderer::GetRendererInstance()->GettrilinearAniso());

	// Load a bumpmap for the cloth. We use UV5L6 format for improved performance.
	Image3 img;
	img.loadImageLibImage("wallpaperBump.png");
	img.generateMipMaps();
	...
	if ((quadVF = IRenderer::GetRendererInstance()->addVertexFormat(quadAttribs, elementsOf(quadAttribs))) == TEXTURE_NONE) return false;
	...
	if ((clothVF = IRenderer::GetRendererInstance()->addVertexFormat(clothAttribs, elementsOf(clothAttribs))) == TEXTURE_NONE) return false;
	...
	if ((clothInterleavedVF = IRenderer::GetRendererInstance()->addVertexFormat(clothILAttribs, elementsOf(clothILAttribs))) == TEXTURE_NONE) return false;

	FormatDesc hitAttribs[] = {
		0, TYPE_VERTEX,   FORMAT_FLOAT,  3
	};
	if ((hitVF = IRenderer::GetRendererInstance()->addVertexFormat(hitAttribs, elementsOf(hitAttribs))) == TEXTURE_NONE) return false;
