...
// Constructor
//-----------------------------------------------------------------------------
CPU_Physics::CPU_Physics(IDirect3DDevice9 *d3dDevice, Renderer *renderer) : Physics(d3dDevice, renderer)
{
    HRESULT hr;
    ...
    V( D3DXCreateTexture (m_d3dDevice, HIGH_FREQ_WATER_GRID_RESOLUTION, HIGH_FREQ_WATER_GRID_RESOLUTION, 0,
                             D3DUSAGE_AUTOGENMIPMAP, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT , &m_pHighNormalTex ) );
    ...
    V( D3DXCreateTexture (m_d3dDevice, HIGH_FREQ_WATER_GRID_RESOLUTION, HIGH_FREQ_WATER_GRID_RESOLUTION, 1,
                0, D3DFMT_A8R8G8B8, D3DPOOL_SYSTEMMEM, &m_pSysMemHighNormalTex ) );
...
void CPU_Physics::ComputeWaves(float windSpeed, float windDirection, float time)
{
    ...
    D3DLOCKED_RECT rect;
    m_pSysMemHighNormalTex->LockRect(0, &rect, NULL, 0);
    memcpy(rect.pBits, m_HighNormalImage,
        HIGH_FREQ_WATER_GRID_RESOLUTION * HIGH_FREQ_WATER_GRID_RESOLUTION * 4);
    m_pSysMemHighNormalTex->UnlockRect(0);
    m_d3dDevice->UpdateTexture(m_pSysMemHighNormalTex, m_pHighNormalTex);
}
