...
const char* filename[] =
{
	...
	"/R2VB-Sort/FirePalette.png",
	"/R2VB-Sort/SmokeAnimation.dds",// black ??? TRILINEAR, CLAMP
...
int init(const char* aTitle)
{
	...
	shaders[0] = IRenderer::GetRendererInstance()->addShaderFromFile("/SimpleTexture/SimpleTexture.shd", "mainVS", "main1D");
	shaders[1] = IRenderer::GetRendererInstance()->addShaderFromFile("/SimpleTexture/SimpleTexture.shd", "mainVS", "main2D");
	shaders[2] = IRenderer::GetRendererInstance()->addShaderFromFile("/SimpleTexture/SimpleTexture.shd", "mainVS", "main3D");
	FormatDesc format[] =
	{
