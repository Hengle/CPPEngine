...
#define VSHN_8_SAMPLES	TEXT("D3D9_Glow\\TexCoordOffset_8_vs20.vsh")
#define PSHN_8_SAMPLES	TEXT("D3D9_Glow\\Add_8Samples_ps20.psh")

#define VSHN_6_SAMPLES	TEXT("D3D9_Glow\\TexCoordOffset_6_vs20.vsh")
#define PSHN_6_SAMPLES	TEXT("D3D9_Glow\\Add_6Samples_ps20.psh")

#define VSHN_4_SAMPLES	TEXT("D3D9_Glow\\TexCoordOffset_4_vs11.vsh")
#define PSHN_4_SAMPLES	TEXT("D3D9_Glow\\Add_4Samples_ps11.psh")

#define VSHN_2_SAMPLES	TEXT("D3D9_Glow\\TexCoordOffset_2_vs11.vsh")
#define PSHN_2_SAMPLES	TEXT("D3D9_Glow\\Add_2Samples_ps11.psh")
...
HRESULT GlowShaderCollection::Free()
{
...
HRESULT GlowShaderCollection::Initialize( IDirect3DDevice9 * pDev, ShaderManager ** ppShaderManager )
{
	HRESULT hr, hr1, hr2;
	hr = S_OK;
	Free();
