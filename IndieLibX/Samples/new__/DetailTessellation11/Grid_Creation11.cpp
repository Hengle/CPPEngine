                          ...
                          VertexBufferID * lplpVB )
{
    ...
    hr = IRenderer::GetRendererInstance()->CreateBuffer( &bd, &InitData, lplpVB );
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_NonIndexed: Failed to create vertex buffer.\n" );
        return;
    }
                       ...
                       VertexBufferID * lplpVB, VertexBufferID * lplpIB )
{
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Indexed: Failed to create vertex buffer.\n" );
        return;
    }
    ...
    // Fill DX11 vertex buffer description
    bd.ByteWidth = sizeof( __WORD__ ) * nNumIndex;
    bd.BindFlags = D3D11_BIND_INDEX_BUFFER;
    
    // Create DX11 index buffer specifying initial data
    hr = IRenderer::GetRendererInstance()->CreateBuffer( &bd, &InitData, lplpIB );
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Indexed: Failed to create index buffer.\n" );
        return;
    }
                                   ...
                                   VertexBufferID * lplpVB, VertexBufferID * lplpIB )
{
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_WithNormals_Indexed: Failed to create index buffer.\n" );
        return;
    }
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_WithNormals_Indexed: Failed to create vertex buffer.\n" );
        return;
    }
                             ...
                             VertexBufferID * lplpVB, VertexBufferID * lplpIB )
{
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Quads_Indexed: Failed to create vertex buffer.\n" );
        return;
    }
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Quads_Indexed: Failed to create index buffer.\n" );
        return;
    }
                                ...
                                VertexBufferID * lplpVB )
{
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Quads_NonIndexed: Failed to create vertex buffer.\n" );
        return;
    }
                                        ...
                                        VertexBufferID * lplpVB, VertexBufferID * lplpIB )
{
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Indexed_WithTangentSpace: Failed to create vertex buffer.\n" );
        return;
    }
    ...
    if( FAILED( hr ) )
    {
        OutputDebugString( "FillGrid_Indexed_WithTangentSpace: Failed to create index buffer.\n" );
        return;
    }
...
void GridOptimizeIndices( __WORD__* pIndexBuffer, int nNumIndex, int nNumVertex )
{
    ...
    memcpy( pTmpIndexBuffer, pIndexBuffer, nNumIndex * sizeof( __WORD__ ) );
