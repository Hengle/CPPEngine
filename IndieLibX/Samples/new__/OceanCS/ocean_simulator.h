...
protected:
	...
	ShaderResourceViewID m_pDisplacementSRV;
	RenderTargetViewID  m_pDisplacementRTV;

	// Gradient field
	TextureID m_pGradientMap;			// (RGBA16F)
	ShaderResourceViewID m_pGradientSRV;
	RenderTargetViewID  m_pGradientRTV;
	...
	ShaderResourceViewID m_pSRV_Ht;
	...
	ShaderResourceViewID m_pSRV_Dxyz;
