...
protected:
  ...
  HRESULT Render();
  HRESULT FrameMove();
  HRESULT ConfirmDevice( D3DCAPS8* pCaps, __DWORD__ dwBehavior, D3DFORMAT Format );
...
//-----------------------------------------------------------------------------
HRESULT CMyD3DApplication::ConfirmDevice( D3DCAPS8* pCaps, __DWORD__ dwBehavior,
                                          D3DFORMAT Format )
{
  return S_OK;
}
