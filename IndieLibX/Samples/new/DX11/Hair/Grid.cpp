...
Grid::Grid( ID3D11Device* IRenderer::GetRendererInstance(), ID3D11DeviceContext* IRenderer::GetRendererInstance()) : IRenderer::GetRendererInstance()(0),IRenderer::GetRendererInstance()(0), m_layout(0), m_renderQuadBuffer(0),
...
int Grid::Initialize( int gridWidth, int gridHeight, int gridDepth,ID3DX11EffectTechnique* technique )
{
    int hr(0);
...
int Grid::CreateVertexBuffers( ID3DX11EffectTechnique* technique )
{
    int hr(0);
...
void Grid::DrawSlices( void )
{
	...
	DrawPrimitive( PRIM_TRIANGLES, m_layout, &m_slicesBuffer,stride, offset, 0, m_numVerticesSlices );
...
void Grid::DrawPrimitive( D3D11_PRIMITIVE_TOPOLOGY PrimitiveType, VertexFormatID* layout,
...
int Grid::CreateLayout( D3D11_INPUT_ELEMENT_DESC* layoutDesc, unsigned int numElements,
                           ID3DX11EffectTechnique* technique, VertexFormatID** layout)
{
    int hr(0);
