...
public:
    ...
    Fluid                   ( ID3D11Device* IRenderer::GetRendererInstance(), ID3D11DeviceContext* IRenderer::GetRendererInstance() );
    virtual ~Fluid          ( void );
...
protected:
    ...
    int CreateTextureAndViews(int rtIndex, D3D11_TEXTURE3D_DESC TexDesc);
    ...
    stx_Variable  *m_evTexture_pressure;
    stx_Variable  *m_evTexture_velocity;
    stx_Variable  *m_evTexture_vorticity;
    stx_Variable  *m_evTexture_divergence;
    stx_Variable  *m_evTexture_phi;
    stx_Variable  *m_evTexture_phi_hat;
    stx_Variable  *m_evTexture_phi_next;
    stx_Variable  *m_evTexture_levelset;
    stx_Variable  *m_evTexture_obstacles;
    stx_Variable  *m_evTexture_obstvelocity;
