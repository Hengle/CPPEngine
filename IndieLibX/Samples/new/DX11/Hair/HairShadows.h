...
public:
	...
	void OnD3D11CreateDevice(ID3D11Device* IRenderer::GetRendererInstance(), ID3D11DeviceContext *IRenderer::GetRendererInstance()) {
		...
		m_pDepthsRT = new SimpleRT( IRenderer::GetRendererInstance(), IRenderer::GetRendererInstance(), &texDesc );
		...
		m_pDepthsDS = new DepthRT( IRenderer::GetRendererInstance(), &texDesc );
		...
		if(m_NumLayers==1)
			m_DOM = new SimpleRT( IRenderer::GetRendererInstance(), IRenderer::GetRendererInstance(), &texDesc2 );
		else
			m_DOM = new SimpleArrayRT( IRenderer::GetRendererInstance(), IRenderer::GetRendererInstance(), &texDesc2 );
		...
		texDesc.SampleDesc.Quality = 0;
		texDesc.Format = DXGI_FORMAT_R32_FLOAT;
		m_pDepthsRT_DOM = new SimpleRT( IRenderer::GetRendererInstance(), IRenderer::GetRendererInstance(), &texDesc );
	...
	void BeginShadowMapRendering(ID3D11Device* IRenderer::GetRendererInstance(), ID3D11DeviceContext* IRenderer::GetRendererInstance(), bool DOMPrepass=false)
	{
	...
	void setupDOMShadowMapRendering(ID3D11DeviceContext* IRenderer::GetRendererInstance())
	{
		IRenderer::GetRendererInstance()->RSSetViewports(1, &m_LViewport);
	...
	void setShadowMapRT(ID3D11DeviceContext* IRenderer::GetRendererInstance())
	{
	...
	void endDOMShadowMapRendering(ID3D11DeviceContext* IRenderer::GetRendererInstance())
	{
	...
	void VisualizeShadowMap(ID3D11Device* IRenderer::GetRendererInstance(), ID3D11DeviceContext* IRenderer::GetRendererInstance())
	{
        ...
        g_Effect->GetTechniqueByName("RenderHair")->GetPassByName("VisualizeShadowMap")->Apply(0, IRenderer::GetRendererInstance());
