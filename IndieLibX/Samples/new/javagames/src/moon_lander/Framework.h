 ...
 */
 ...
 struct Framework : public Canvas {
   ...
   /**
     ...
     void LoadContent()
    {
        try
        {
            URL moonLanderMenuImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/moon_lander/menu.jpg");
