 ...
 struct Game {
   ...
   /**
     ...
     void LoadContent()
    {
        try
        {
            URL backgroundImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/moon_lander/background.jpg");
            backgroundImg = ImageIO.read(backgroundImgUrl);
            
            URL redBorderImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/moon_lander/red_border.png");
