 ...
 */
 ...
 struct Game {
    ...
    // Enemy helicopters.
     std::vector<EnemyHelicopter> enemyHelicopterList = new std::vector<EnemyHelicopter>();
    
    // Explosions
     std::vector<Animation> explosionsList;
     Image3 explosionAnimImg;
   ...
   /**
     ...
     void Initialize()
    {
        ...
        enemyHelicopterList = new std::vector<EnemyHelicopter>();
        
        explosionsList = new std::vector<Animation>();
        
        bulletsList = new std::vector<Bullet>();
        
        rocketsList = new std::vector<Rocket>();
        rocketSmokeList = new std::vector<RocketSmoke>();
     ...
     void LoadContent()
    {
        try 
        {
            ...
            URL mountainsImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/mountains.png");
            mountainsImg = ImageIO.read(mountainsImgUrl);
            URL groundImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/ground.png");
            groundImg = ImageIO.read(groundImgUrl);
            
            // Load images for enemy helicopter
            URL helicopterBodyImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/2_helicopter_body.png");
            EnemyHelicopter.helicopterBodyImg = ImageIO.read(helicopterBodyImgUrl);
            URL helicopterFrontPropellerAnimImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/2_front_propeller_anim.png");
            EnemyHelicopter.helicopterFrontPropellerAnimImg = ImageIO.read(helicopterFrontPropellerAnimImgUrl);
            URL helicopterRearPropellerAnimImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/2_rear_propeller_anim.png");
            ...
            URL rocketImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/rocket.png");
            Rocket.rocketImg = ImageIO.read(rocketImgUrl);
            URL rocketSmokeImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/rocket_smoke.png");
            RocketSmoke.smokeImg = ImageIO.read(rocketSmokeImgUrl);
            
            // Imege of explosion animation.
            URL explosionAnimImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/explosion_anim.png");
            explosionAnimImg = ImageIO.read(explosionAnimImgUrl);
            
            // Image of mouse cursor.
            URL mouseCursorImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/mouse_cursor.png");
            mouseCursorImg = ImageIO.read(mouseCursorImgUrl);
            
            // Helicopter machine gun bullet.
            URL bulletImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/bullet.png");
