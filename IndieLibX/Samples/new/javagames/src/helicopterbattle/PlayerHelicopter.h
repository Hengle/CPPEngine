 ...
 */
 ...
 struct PlayerHelicopter {
     ...
     void LoadContent()
    {
        try 
        {
            URL helicopterBodyImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/1_helicopter_body.png");
            helicopterBodyImg = ImageIO.read(helicopterBodyImgUrl);
            
            URL helicopterFrontPropellerAnimImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/1_front_propeller_anim.png");
            helicopterFrontPropellerAnimImg = ImageIO.read(helicopterFrontPropellerAnimImgUrl);
            
            URL helicopterRearPropellerAnimImgUrl = IRenderer::GetRendererInstance()->addImageLibTexture("/helicopterbattle/1_rear_propeller_anim_blur.png");
            helicopterRearPropellerAnimImg = ImageIO.read(helicopterRearPropellerAnimImgUrl);
        } 
        catch (IOException ex) {
            Logger.getLogger(PlayerHelicopter.struct.getName()).log(Level.SEVERE, null, ex);
        }
