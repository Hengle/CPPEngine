                                ...
                                const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
	...
	V_RETURN( LoadMesh ( pd3dDevice, L"models\\SpaceShip\\missile1.x", g_aCloneMeshVertDecl, 
	...
	V_RETURN( LoadMesh ( pd3dDevice, L"models\\Asteroid\\aster1.x", g_aCloneMeshVertDecl, 
	...
	WCHAR str[MAX_PATH];
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"programs\\HLSL_Instancing\\HLSL_Instancing.fx" ) );
	V_RETURN( D3DXCreateEffectFromFile( pd3dDevice, str, NULL, NULL, dwShaderFlags, NULL, &g_pEffect, NULL ) );

	// Create the mesh texture from a file
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"models\\SpaceShip\\missile1-Color.dds" ) );
	...
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"models\\SpaceShip\\missile1-normal.dds" ) );
	...
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"models\\Asteroid\\aster1.dds" ) );
	...
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"models\\Asteroid\\aster1-normal.dds" ) );
	...
	V_RETURN( DXUTFindDXSDKMediaFileCch( str, MAX_PATH, L"textures\\cubemaps\\biggerStars.dds" ) );
