...
const char* filename[] =
{
"/R2VB-Sort/SmokeAnimation.dds",
"/R2VB-Sort/FireNoise.dds",
0
};
...
#if 1
#if 1
	firePalette = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/FirePalette.png", true, IRenderer::GetRendererInstance()->Getlinear());
	SmokeAnimation=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/SmokeAnimation.dds", true, IRenderer::GetRendererInstance()->Getlinear());
#elif 0
	noise = IRenderer::GetRendererInstance()->addTexture(&img, true, IRenderer::GetRendererInstance()->Getlinear());
	firePalette = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/FirePalette.png", true, IRenderer::GetRendererInstance()->Getlinear());
	SmokeAnimation=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/SmokeAnimation.dds", true, IRenderer::GetRendererInstance()->Gettrilinear());
#else
	noise = IRenderer::GetRendererInstance()->addTexture(&img, true, IRenderer::GetRendererInstance()->Getlinear());
	firePalette = IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/FirePalette.png", true, IRenderer::GetRendererInstance()->GetlinearClamp());
	SmokeAnimation=IRenderer::GetRendererInstance()->addImageLibTexture("/R2VB-Sort/SmokeAnimation.dds", true, IRenderer::GetRendererInstance()->GettrilinearClamp());
#endif
#else
