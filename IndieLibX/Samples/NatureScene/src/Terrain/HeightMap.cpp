                      ...
                      const Image3&  watermap)
{
  ...
  const ubyte *hmBytes      = heightmap.getDataBuffer(),
                *wmBytes      = watermap.getDataBuffer();


  float          waterHeight  = 0,
                 newHeight    = 0;
  int            hmByteCount  = heightmap.getComponentsCount(),
                 wmByteCount  = watermap.getComponentsCount(),
                 index        = 0;
