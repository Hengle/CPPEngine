...
void NSCamera::setKeyboardInput()
{
  ...
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_w) || STX_Service::GetInputInstance()->IsKeyPressed(KEY_UP))
	activeKeys[0] = true;
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_s) || STX_Service::GetInputInstance()->IsKeyPressed(KEY_DOWN))
	activeKeys[1] = true;
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_a) || STX_Service::GetInputInstance()->IsKeyPressed(KEY_LEFT))
	activeKeys[2] = true;
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_d) || STX_Service::GetInputInstance()->IsKeyPressed(KEY_RIGHT))
	activeKeys[3] = true;
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_e))
	activeKeys[4] = true;
  if(STX_Service::GetInputInstance()->IsKeyPressed(KEY_q))
	activeKeys[5] = true;
