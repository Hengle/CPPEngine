...
void _DbgOut(char* strFile, unsigned long dwLine, int hr, char *strMsg);
void _ErrorOut(char *strFile, unsigned long dwLine, int hr);

#if defined(DEBUG) | defined(_DEBUG)
    #define DD_ERR(hr) _ErrorOut(__FILE__, (unsigned long)__LINE__, hr)
#else
    #define DD_ERR(hr)
#endif
