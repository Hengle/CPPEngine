...
protected:
    ...
    // Window size
    unsigned long m_dwFSWidth;
    unsigned long m_dwFSHeight;
    bool m_bActive;
    ...
    // Performance stats
    unsigned long m_dwFPS;
    unsigned long m_dwPPS;
    unsigned long m_dwLoopFrames;
    unsigned long m_dwLoopCount;
    unsigned long m_dwLastPerfTime;
    char m_strStats[128];
/*
