...
#define defaultshader eDirectionalLighting
//define defaultshader eSpotLighting
//define defaultshader eMultiLighting
...
{
	IRenderer* r=IRenderer::GetRendererInstance("DirectionalLighting");
