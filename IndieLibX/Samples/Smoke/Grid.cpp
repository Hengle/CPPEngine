...
Grid::Grid( ID3D10Device* pd3dDevice ) : m_pD3DDevice(NULL), m_layout(NULL), m_renderQuadBuffer(NULL),
...
void Grid::DrawSlices( void )
{
    ...
    UINT offset[1] = { 0 };
    DrawPrimitive( D3D10_PRIMITIVE_TOPOLOGY_TRIANGLELIST, m_layout, &m_slicesBuffer,
...
void Grid::DrawSlicesToScreen( void )
{
    UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
    UINT offset[1] = { 0 };
    DrawPrimitive( D3D10_PRIMITIVE_TOPOLOGY_TRIANGLELIST, m_layout, &m_renderQuadBuffer,
...
void Grid::DrawBoundaryQuads( void )
{
    UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
    UINT offset[1] = { 0 };
    DrawPrimitive( D3D10_PRIMITIVE_TOPOLOGY_TRIANGLELIST, m_layout, &m_boundarySlicesBuffer,
...
void Grid::DrawBoundaryLines( void )
{
    ...
    UINT stride[1] = { sizeof(VS_INPUT_FLUIDSIM_STRUCT) };
    UINT offset[1] = { 0 };
    DrawPrimitive( D3D10_PRIMITIVE_TOPOLOGY_LINELIST, m_layout, &m_boundaryLinesBuffer, 
