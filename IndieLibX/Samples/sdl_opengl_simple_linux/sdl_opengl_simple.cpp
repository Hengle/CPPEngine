...
#if 0
float g_fTScale		 = 0.25f;
float g_fScale		 = 2.0f;
#else
float g_fTScale		 = 1.0f;
float g_fScale		 = 1.0f;
#endif
float g_fSpinX           = 0.0f;
float g_fSpinY           = 0.0f;
...
{
    { 0.0f,0.0f, -g_fTScale,-g_fTScale, 0.0f },
    { 1.0f,0.0f,  g_fTScale,-g_fTScale, 0.0f },
    { 1.0f,1.0f,  g_fTScale, g_fTScale, 0.0f },
    { 0.0f,1.0f, -g_fTScale, g_fTScale, 0.0f }
};
...
void loadTexture( void )    
{
    ...
    getBitmapImageData( "../../IndieLib_resources/test.bmp", &textureImage );
...
void render_(const float aX, const float aY, const float aZ, const float aSpinX, const float aSpinY)
{
    glMatrixMode( GL_MODELVIEW );
    glLoadIdentity();
#if 1
    glTranslatef( aX, aY, aZ-6.0f );
    glRotatef( -aSpinY, 1.0f, 0.0f, 0.0f );
    glRotatef( -aSpinX, 0.0f, 1.0f, 0.0f );
	glScalef( g_fScale, g_fScale, g_fScale );
#elif 0
	glTranslatef(0.0, 0.0, -6.0f);
	glRotatef(45.0, 1.0f, 0.0, 0.0);
...
void render( void )
{
    ...
    render_( 0.5f*g_fTScale, -g_fTScale, 0.0f, 0*90.0f+g_fSpinX, g_fSpinY);
    render_( g_fTScale,  0.5f*g_fTScale, 0.0f, 1*90.0f+g_fSpinX, g_fSpinY);
    render_( 0.5f*g_fTScale,  g_fTScale, 0.0f, 0*90.0f+g_fSpinX, g_fSpinY);
    render_(-g_fTScale,  0.5f*g_fTScale, 0.0f, 1*90.0f+g_fSpinX, g_fSpinY);
